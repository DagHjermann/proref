...
- The whole script is a bit slow - it takes about two hours (one hour for "Run analysis for data through 2022", one hour for "add the actual proref")  
...
- takes 37 minutes with 6 cores running in parallel  
...
result_summ %>%
  readr::write_csv("Data/54_result_summ_2024-11-27.csv")  # HARD-CODED

result_summ %>%
  filter(Background %in% "Background 1b") %>%
  readr::write_csv("Data/54_result_summ_final_2024-11-27.csv.csv")  # HARD-CODED
