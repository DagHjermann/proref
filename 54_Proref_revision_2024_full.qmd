...
```
### Run analysis for data through 2022, parallel processing

```{r}

# Test using 'foreach' package
#
# t0 <- Sys.time()
# result_list2 <- foreach(i = 1:3, .packages = c("dplyr", "purrr")) %dopar% {
#   source("54fun_Calculate_PROREF_functions.R")
#   try(get_background_values(
