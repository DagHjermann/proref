...
df_series_sel <- readRDS("Data/54_data_2024.rds")
...
fn1 <- paste0("Data/54_result_summ_", txt_years, "_", timestamp, ".csv")
result_summ %>%
  readr::write_csv(fn1)  

fn2 <- paste0("Data/54_result_summ_final_", txt_years, "_", timestamp, ".csv")
result_summ %>%
