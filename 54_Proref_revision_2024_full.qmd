...
# 23 more parameters lost as number of stations were zero (ts = 0)
# 116 parameters kept (ts = 1)
...
#  [1] "BA"      "MO"      "NAP"     "BAA"     "BKF"     "BAP"     "DBA3A"   "PER"     "BDE156" 
# [10] "BDE191"  "MBT"     "DBT"     "TTBT"    "TPhT"    "MOT"     "DOT"     "TCHT"    "MBT-Sn" 
# [19] "DBT-Sn"  "TTBT-Sn" "TPhT-Sn" "MOT-Sn"  "TEHP"  
...
# table(addNA(result_detailed_summ$result1_cod))
# table(addNA(result_detailed_summ$result1_mussel))
...
table(addNA(params_fate3$result1_mussel))
table(addNA(params_fate3$result1))
table(addNA(params_fate3$result1_mussel), addNA(params_fate3$result1))

# 23 more parameters lost  
table(addNA(params_fate3$ts), addNA(params_fate3$filtered_high_lessthans))

  # 30 more parameters lost  
  table(addNA(params_fate3$result1), addNA(params_fate3$filtered_high_lessthans))
  #          1 <NA>
  #   1      0  109
  #   <NA>  10   30
